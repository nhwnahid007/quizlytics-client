  ...
  return (
    <div className="relative bg-white overflow-hidden">
      ...
      <div className="mx-auto">
        <div className="text-black p-10 bg-gray-100 shadow-lg">
          ...
          <div className="grid md:grid-cols-4 gap-3">
            <div>
              <h3 className="text-xl font-semibold mb-2 text-Black">Services</h3>
              {/* <nav>
            ...
            <div>
              ...
              <nav>
              <Link href={"/about"}>  <p className="block hover:text-yellow-400 transition-colors duration-300">About us</p></Link>
               <Link href={"/contact"}> <p className="block hover:text-yellow-400 transition-colors duration-300">Contact</p></Link>
              <Link href={"/team"}>  <p className="block hover:text-yellow-400 transition-colors duration-300">Our team</p></Link>
            ...
            <div className="text-center mt-6 text-Black">
              ...
              <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className=" transform hover:scale-125 hover:text-blue-500 transition-transform duration-300 ease-in-out animate-bounce">
                                <FaFacebook size={30} />
                            </a>

                            <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer" className=" transform hover:scale-125 hover:text-blue-300 transition-transform duration-300 ease-in-out animate-bounce">
                                <FaTwitter size={30} />
                            </a>

                            <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className=" transform hover:scale-125 hover:text-blue-600 transition-transform duration-300 ease-in-out animate-bounce">
                                <FaLinkedin size={30} />
                            </a>

                            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className=" transform hover:scale-125 hover:text-pink-400 transition-transform duration-300 ease-in-out animate-bounce">
                                <FaInstagram size={30} />
                            </a>
