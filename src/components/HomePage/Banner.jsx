        ...
        <div className="relative z-10 flex flex-col lg:flex-row justify-between gap-8 px-8 lg:px-20 pt-16">
          <div className="w-full lg:w-[70%] md:pr-32">
            <div className="w-full md:w-[683px]">
              <h1 className="  md:text-2xl lg:text-5xl font-bold text-[#333333] mb-5 lg:mb-14 md:h-6 lg:h-12  md:pr-20">
                <Typewriter
                options={{
              ...
              <div className="flex flex-col lg:flex-row gap-4 lg:mt-8">
                <button
                  onClick={handleQuicktExam}
                  className="px-6 md:px-12 py-2 lg:py-4 rounded-xl font-bold border-2 text-white bg-primary-color hover:bg-transparent hover:text-primary-color transition-colors duration-300 border-gradient"
                >
                  Quick Exam
                </button>
                <button
                  onClick={handleCustomExam}
                  className="px-6 md:px-12 py-2 lg:py-4 rounded-xl font-bold border-2 text-white bg-secondary-color hover:bg-transparent hover:text-secondary-color transition-colors duration-300 border-gradient"
                >
                  Custom Exam
                </button>
                <button
          ...
          <div className="w-full mt-1 lg:mt:0 md:mt-0 lg:w-[30%] flex justify-center items-center">
            <div className="grid grid-cols-2 lg:grid-cols-2 md:grid-cols-4 gap-4">
              {/* Image 1 */}
              <div className="relative w-[100px] h-[80px] lg:w-[140px] lg:h-[130px] bg-secondary-color bg-opacity-60 text-black flex justify-center items-center rounded-2xl pulse flip">
                <Image
              ...
              {/* Image 2 */}
              <div className="relative w-[100px] h-[80px] lg:w-[140px] lg:h-[130px] bg-primary-color bg-opacity-60 text-black flex justify-center items-center rounded-2xl pulse flip">
                <Image
              ...
              {/* Image 3 */}
              <div className="relativew-[100px] h-[80px] lg:w-[140px] lg:h-[130px] bg-primary-color bg-opacity-60 text-black flex justify-center items-center rounded-2xl pulse flip">
                <Image
