...
import { PenTool, Users, BarChart2, Share2, BrainCircuit, MonitorCog, Link } from 'lucide-react';
...
<div data-aos="zoom-in" className="bg-gray-100 rounded-lg shadow-md p-6 text-center flex-1">
                ...
                <BrainCircuit className="w-12 h-12 mx-auto mb-4 text-primary-color" />
            ...
            <div data-aos="zoom-in" className="bg-gray-100 rounded-lg shadow-md p-6 text-center flex-1">
                <PenTool className="w-12 h-12 mx-auto mb-4 text-primary-color" />
            ...
            <div data-aos="zoom-in" className="bg-gray-100 rounded-lg shadow-md p-6 text-center flex-1">
                 ...
                 */}
                 <MonitorCog className="w-12 h-12 mx-auto mb-4 text-primary-color" />
            ...
            <div data-aos="zoom-in" className="bg-gray-100 rounded-lg shadow-md p-6 text-center flex-1">
                 ...
                 */}
                <Link className="w-12 h-12 mx-auto mb-4 text-primary-color" />
