...
const ServicesPage = () => {
  return (
    <div className="">
      <section className="bg-[#1b1b1b] dark:bg-gray-900">
        <div className="container px-6 py-8 mx-auto">
          <h2 className="text-2xl font-semibold text-center text-[#ffefd3] capitalize lg:text-5xl dark:text-white">
            Our Team
          </h2>
          ...
          <div className="grid gap-8 mt-8 sm:grid-cols-2 lg:grid-cols-3 justify-center">
            ...
            <div className="w-full max-w-xs text-center  mx-auto">
              <Image
                ...
                src="https://i.ibb.co.com/Gp2pbHR/304944883-193506636368131-6096839391558381294-n.jpg " // Replace with a correct URL or path
                alt="Nahid"
                width={300}
                height={300}
              />
              <div className="mt-2">
                <h3 className="text-lg font-medium text-[#ffefd3] dark:text-gray-200">Nahid</h3>
            ...
            <div className="w-full max-w-xs text-center mx-auto">
              ...
              />
              <div className="mt-2">
                <h3 className="text-lg font-medium text-[#ffefd3] dark:text-gray-200">Musa Akram Saleh</h3>
            ...
            <div className="w-full max-w-xs text-center mx-auto">
              ...
              />
              <div className="mt-2">
                <h3 className="text-lg font-medium text-[#ffefd3] dark:text-gray-200">Rafiul Habib Razib</h3>
                <span className="mt-1 font-medium text-red-600 dark:text-gray-300">Team Member</span>
              </div>
            </div>
            ...
            <div className="w-full max-w-xs text-center mx-auto">
              ...
              />
              <div className="mt-2">
                <h3 className="text-lg font-medium text-[#ffefd3] dark:text-gray-200">Sayed Rana</h3>
                <span className="mt-1 font-medium text-red-600 dark:text-gray-300">Team Member</span>
              </div>
            </div>
            ...
            <div className="w-full max-w-xs text-center mx-auto">
              ...
              />
              <div className="mt-2">
                <h3 className="text-lg font-medium text-[#ffefd3] dark:text-gray-200">Tanvir Rahman Saim</h3>
                <span className="mt-1 font-medium text-red-600 dark:text-gray-300">Team Member</span>
              </div>
            </div>
            ...
            <div className="w-full max-w-xs text-center mx-auto">
              ...
              />
              <div className="mt-2">
                <h3 className="text-lg font-medium text-[#ffefd3] dark:text-gray-200">Ashim Kumar Sarker</h3>
                <span className="mt-1 font-medium text-red-600 dark:text-gray-300">Team Member</span>
              </div>
            </div>
          </div>
