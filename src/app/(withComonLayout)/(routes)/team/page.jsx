    ...
    <div className="">
      <section className="relative bg-gray-100 py-10 ">
        <div className="container px-6   mx-auto">
          <h2 className="text-center my-5 text-3xl font-bold  ">
           Meet Our Team
          </h2>

          <div className=" max-w-4xl  grid gap-7  sm:grid-cols-2 lg:grid-cols-3 mx-auto p-4 py-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            {/* Team Member 1 */}
            <div className=" max-w-xs text-center mx-auto relative">
              <div className="relative group">
                <Image
                  className="object-cover object-center w-[150px] h-[150px] mx-auto rounded-full"
